...
import { Wallet, ChevronLeft, Calendar, Lock, LucideIcon } from "lucide-react";
...
import AdvancedKPI from "./AdvancedKPI";
import UnitEconomyWaterfall from "./UnitEconomyWaterfall";
import AIFinanceInsights from "./AIFinanceInsights";
import CashFlowAnalysis from "./CashFlowAnalysis";
import SKUProfitabilityMatrix from "./SKUProfitabilityMatrix";
import WorkingCapitalDynamics from "./WorkingCapitalDynamics";
import InteractivePNL from "./InteractivePNL";
import LostProfitCalculator from "./LostProfitCalculator";
import AdProfitabilityAnalysis from "./AdProfitabilityAnalysis";
import TaxReserveBasic from "./TaxReserveBasic";
import FinanceTimeline from "./FinanceTimeline";
import ErrorCostIndex from "./ErrorCostIndex";
import PeriodComparisonLFL from "./PeriodComparisonLFL";
...
interface FinanceViewProps {
  ...
  setActiveTab: (val: "basic" | "advanced") => void;
  hasFinancialData: boolean;
  setHasFinancialData: (val: boolean) => void;
  tabs: Tab[];
}
